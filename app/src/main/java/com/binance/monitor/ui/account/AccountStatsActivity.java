...
public class AccountStatsActivity extends AppCompatActivity {
    ...
    private AccountStatsRepository repository;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        repository = new AccountStatsRepository();
    ...
    private void reloadData() {
        com.binance.monitor.ui.account.model.AccountSnapshot snapshot = repository.load(selectedRange);
