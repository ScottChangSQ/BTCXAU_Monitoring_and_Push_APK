...
class V2SessionModelsTests(unittest.TestCase):
    ...
    def test_session_account_summary_from_mapping_should_treat_activated_as_active(self):
        """恢复接口字典时，state=activated 也应视为激活态。"""
    ...
    def test_session_receipt_should_fill_optional_defaults(self):
        ...
        self.assertEqual("acct_123_icmarkets", payload["account"]["profileId"])
